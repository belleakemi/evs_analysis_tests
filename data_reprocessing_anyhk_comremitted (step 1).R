...
nanosight_plus_sampleinfo_anyhk_comremitted <- nanosight_plus_sampleinfo[!is.na(nanosight_plus_sampleinfo$grupo_analise_anyhk), ]
n_depois <- nrow(nanosight_plus_sampleinfo)
print(table(nanosight_plus_sampleinfo_anyhk_comremitted$grupo_analise_anyhk))
nanosight_plus_sampleinfo_anyhk_comremitted <- nanosight_plus_sampleinfo_anyhk_comremitted %>%
