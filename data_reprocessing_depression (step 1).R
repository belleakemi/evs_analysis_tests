...
##Retirando outliers
nanosight_plus_sampleinfo_dep$zscore_mode <- scale(nanosight_plus_sampleinfo_dep$tamanho_mode_average)
...
nanosight_plus_sampleinfo_dep_sem_outliers_mode <- nanosight_plus_sampleinfo_dep[nanosight_plus_sampleinfo_dep$zscore_mode >= -3.0 & nanosight_plus_sampleinfo_dep$zscore_mode <= 3.0, ]
...
nanosight_plus_sampleinfo_dep_sem_outliers_mode_concentracao <- semi_join(nanosight_plus_sampleinfo_dep_sem_outliers_mode, nanosight_plus_sampleinfo_dep_sem_outliers_concentracao, by = "id_sample")
...
nanosight_plus_sampleinfo_dep_sem_outliers_mode_porcentagem <- semi_join(nanosight_plus_sampleinfo_dep_sem_outliers_mode, nanosight_plus_sampleinfo_dep_sem_outliers_porcentagem, by = "id_sample")
nanosight_intersect_dep_mode <- semi_join(nanosight_plus_sampleinfo_dep_sem_outliers_mode_concentracao, nanosight_plus_sampleinfo_dep_sem_outliers_porcentagem, by = ("id_sample"))
nanosight_outliers_dep_mode <- anti_join(nanosight_plus_sampleinfo_dep, nanosight_intersect_dep_mode, by = "id_sample")
