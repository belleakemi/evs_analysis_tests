...
##Retirando outliers
nanosight_plus_sampleinfo_gena_comremitted$zscore_mean <- scale(nanosight_plus_sampleinfo_gena_comremitted$tamanho_mean_average)
...
nanosight_plus_sampleinfo_gena_comremitted_sem_outliers_mean <- nanosight_plus_sampleinfo_gena_comremitted[nanosight_plus_sampleinfo_gena_comremitted$zscore_mean >= -3.0 & nanosight_plus_sampleinfo_gena_comremitted$zscore_mean <= 3.0, ]
...
nanosight_plus_sampleinfo_gena_comremitted_sem_outliers_mean_concentracao <- semi_join(nanosight_plus_sampleinfo_gena_comremitted_sem_outliers_mean, nanosight_plus_sampleinfo_gena_comremitted_sem_outliers_concentracao, by = "id_sample")
...
nanosight_plus_sampleinfo_gena_comremitted_sem_outliers_mean_porcentagem <- semi_join(nanosight_plus_sampleinfo_gena_comremitted_sem_outliers_mean, nanosight_plus_sampleinfo_gena_comremitted_sem_outliers_porcentagem, by = "id_sample")
nanosight_intersect_gena_comremitted <- semi_join(nanosight_plus_sampleinfo_gena_comremitted_sem_outliers_mean_concentracao, nanosight_plus_sampleinfo_gena_comremitted_sem_outliers_porcentagem, by = ("id_sample"))
nanosight_outliers_gena_comremitted <- anti_join(nanosight_plus_sampleinfo_gena_comremitted, nanosight_intersect_gena_comremitted, by = "id_sample")

##Tabela só com w1 e só w2
nanosight_w1_gena_comremitted <- subset(nanosight_intersect_gena_comremitted, wave == "t1")
nanosight_w2_gena_comremitted <- subset(nanosight_intersect_gena_comremitted, wave == "t2")
nanosight_intersect_pares_gena_comremitted <- semi_join(nanosight_w1_gena_comremitted, nanosight_w2_gena_comremitted, by = ("subjectid"))
